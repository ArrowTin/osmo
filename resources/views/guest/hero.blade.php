<section id="home" class="max-w-5xl mx-auto px-6 pt-24 pb-32 flex flex-col md:flex-row items-center gap-12">
    <div class="flex-1">
      <h1 class="text-4xl md:text-5xl font-extrabold leading-tight">Do more with less clutter.</h1>
      <p class="mt-4 text-gray-600">{{env('APP_NAME')}} is a minimalist productivity app that keeps you focused on what matters—no bloat, just results.</p>
